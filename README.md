...
<p align="center">
  ...
  <a href="https://prathxmop.github.io/BlockGuard/"><b>Full Docs Website 📚</b></a>
</p>
...
1. **On-the-Go Protection (No Router or VPN needed)**  
   Alternatives like **Pi-hole** or **AdGuard Home** require you to maintain a dedicated, always-on physical server (like a Raspberry Pi) at home. The moment you leave your house, your protection is gone. BlockGuard runs natively on your machine, shielding you wherever you go (offices, cafes, airports).
2. **Safe Auto-Recovery (Worth it alone!)**  
   Manually configuring your DNS settings or using free command-line scripts often leaves your system DNS "stuck" pointing to nothing when you stop them or they crash, breaking your internet connection completely. BlockGuard has a built-in safety net: when you run `sudo blockguard stop`, it **automatically restores your network defaults** and restarts `systemd-resolved` to guarantee seamless uptime.
